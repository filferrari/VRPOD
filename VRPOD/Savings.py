        ...
        for k in range(customers):
            for l in range(k, customers):
                if k != l and k in x and l in x and (l <= instance.C-1 or k <= instance.C-1):
                    if (dist(x[k],instance = instance) + dist(x[l],instance = instance) - dist(newtour(x[k], x[l]),instance = instance)) > maxsaving and (capacity(newtour(x[k], x[l]),instance = instance)) <= instance.Q and (l <= instance.C-1 and k <= instance.C-1):

                        maxsaving = dist(x[l],instance = instance) + dist(x[k],instance = instance) - dist(newtour(x[k], x[l]),instance = instance)
                        saveroute = newtour(x[k], x[l])
                        parent1 = k
                        parent2 = l
                    elif (dist(x[k],instance = instance) + dist(x[l],instance = instance) - dist(newtour(x[k], x[l]),instance = instance)) > maxsaving and (capacity(newtour(x[k], x[l]),instance = instance)) <= instance.Q and l > instance.C-1 and len(newtour(x[k], x[l]))==4 and (realdistOD(newtour(x[k], x[l]),instance = instance)-instance.d_sd[0,l+1])<instance.max_dev*instance.d_sd[0,l+1]:

                        maxsaving = dist(x[l], instance=instance) + dist(x[k], instance=instance) - dist(newtour(x[k], x[l]), instance=instance)
                        saveroute = newtour(x[k], x[l])
                        parent1 = k
                        parent2 = l
                    elif (dist(x[k],instance = instance) + dist(x[l],instance = instance) - dist(newtour(x[k], x[l]),instance = instance)) > maxsaving and (capacity(newtour(x[k], x[l]),instance = instance)) <= instance.Q and k > instance.C-1 and len(newtour(x[k], x[l]))==4 and (realdistOD(newtour(x[k], x[l]),instance = instance)-instance.d_sd[0,k+1])<instance.max_dev*instance.d_sd[0,k+1]:
                        maxsaving = dist(x[l], instance=instance) + dist(x[k], instance=instance) - dist(newtour(x[k], x[l]), instance=instance)
                        saveroute = newtour(x[k], x[l])
                        parent1 = k
                        parent2 = l
